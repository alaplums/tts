...
public class TexlipsePreferenceInitializer extends
    ...
    private void initializePaths(IPreferenceStore pref) {
    	...
    	//String genericPath = Paths.get(".").toAbsolutePath().normalize().toString();
        //String path = PathUtils.findInEnvPath("latex", "/usr/bin", "latex.exe", genericPath + "\\MiKTeX 2.9\\miktex\\bin\\x64");
    	
    	String path = PathUtils.findInEnvPath("latex", "/usr/bin", "latex.exe", "C:\\Program Files" + "\\MiKTeX 2.9\\miktex\\bin\\x64");
        ...
        changeTexDistribution(); //to make sure builder settings get initalized in the first run
    }
    
    private void changeTexDistribution() { //function copied from BuilderSettingsPreferencePage
        String texDir = "C:\\Program Files\\MiKTeX 2.9\\miktex\\bin\\x64";
