...
//        formatChooser.setItems(new String[] {  TexlipseProperties.OUTPUT_FORMAT_PDF });
        formatChooser.select(3);
//        formatChooser.setEnabled(false);
        ...
        sequenceChooser.select(3);
        
        
//        sequenceChooser.setEnabled(false);
        
        System.out.println(sequenceChooser.getSelectionIndex());
