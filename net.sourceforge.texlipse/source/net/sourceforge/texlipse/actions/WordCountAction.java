...
/**
 * A LaTeX cord counter. Counts only normal words, \cite's as one word and the
 * words in the mandatory argument of the sectioning commands.
 * 
...
public class WordCountAction implements IEditorActionDelegate {
	...
	public void run(IAction action) {
		...
		MessageDialog.openInformation(textEditor.getSite().getShell(), "Texlipse Plug-in",
