...
public class TTSONAction implements IEditorActionDelegate
{
	...
	public void run(IAction action) {
        if (textEditor == null)
            return;
        TTSConversion TTS = new TTSConversion();
			try {
				TTS.speak(TTSProperties.SEND_DATA_SPECIAL_CMND);
				Thread.sleep(500);
				TTS.speak(TTSProperties.MSG_TTS_ENABLED);
				TTS.setTTSPowerFlag(true);
