...
//			if(((Button)e.widget).equals(buttons[buttons.length-1])){
//			try {
//				TTSConversion.getDefault().speak("This is input text field");
...
//			try {
//				TTSConversion.getDefault().speak(((Button)e.widget).getText());
//			} catch (IOException e1) {
...
//			}
	...
	protected void createButtonsForButtonBar(final Composite parent) {
        ...
        for (int i = 0; i < buttonLabels.length; i++) {
            ...
            buttons[i] = button;
            buttons[i].addFocusListener(this.listener);
        }
        this.customArea.addFocusListener(this.listener);
    }
